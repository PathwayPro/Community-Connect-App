    ...
    <Popover open={open} onOpenChange={setOpen} modal={modal}>
      <PopoverTrigger asChild>
        {renderTrigger ? (
          ...
          <div
            className={cn(
              'flex h-12 w-full cursor-pointer items-center rounded-xl border border-input bg-neutral-light-100 pe-1 ps-3 text-sm font-normal shadow-sm',
      ...
      <PopoverContent className="min-h-[300px] w-auto p-4" align="end">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="mt-4 flex flex-row-reverse items-center justify-between">
            <Button className="ms-2 h-10 px-4" onClick={onSubmit}>
              Done
            </Button>
            {timezone && (
