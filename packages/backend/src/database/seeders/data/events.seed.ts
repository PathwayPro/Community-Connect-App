...
export const EventsInvitationsData: EventsInvitations[] = [
  {
    ...
    created_at: new Date('2024-12-19 01:48:22:738'),
  },
  {
    id: 3,
    inviter_id: 9,
    ...
    event_id: 7,
    message: 'Invitation message...',
    created_at: new Date('2024-12-19 02:48:22:738'),
  },
  {
    id: 4,
    inviter_id: 8,
    ...
    event_id: 6,
    message: 'Invitation message...',
    created_at: new Date('2024-12-19 03:48:22:738'),
  },
  {
    id: 5,
    inviter_id: 10,
    ...
    event_id: 6,
    message: 'Invitation message...',
    created_at: new Date('2024-12-19 04:48:22:738'),
  },
  {
    id: 6,
    inviter_id: 10,
    ...
    event_id: 7,
    message: 'Invitation message...',
    created_at: new Date('2024-12-19 05:48:22:738'),
  },
  {
    id: 7,
    inviter_id: 11,
    ...
    event_id: 7,
    message: 'Invitation message...',
    created_at: new Date('2024-12-19 06:48:22:738'),
  },
  {
    id: 10,
    inviter_id: 9,
    ...
    event_id: 3,
    message: 'Invitation message...',
    created_at: new Date('2024-12-19 07:48:22:738'),
  },
  {
    id: 11,
    inviter_id: 8,
    ...
    event_id: 3,
    message: 'Invitation message...',
    created_at: new Date('2024-12-19 08:48:22:738'),
  },
];
...
export const EventsSubscriptionsData: EventsSubscriptions[] = [
  {
    ...
    event_id: 2,
    status: 'IN_PROGRESS',
    created_at: new Date('2024-12-21 18:39:51:606'),
    updated_at: new Date('2024-12-21 19:39:51:606'),
  },
  {
    id: 3,
    user_id: 3,
  ...
  },
  {
    ...
    event_id: 4,
    status: 'REJECTED',
    created_at: new Date('2024-12-22 18:39:51:606'),
    updated_at: new Date('2024-12-22 19:39:51:606'),
  },
  {
    id: 7,
    user_id: 1,
...
export const EventsSubscriptionsUpdatesData: EventsSubscriptionsUpdates[] = [
  {
    id: 1,
    message: 'Is in review now',
    subscription_id: 3,
    prev_status: 'PENDING',
    new_status: 'IN_PROGRESS',
    updated_by: 1,
    created_at: new Date('2024-12-21 19:40:35.4'),
  },
  {
    id: 2,
    message: 'Not a nice application',
    subscription_id: 3,
    prev_status: 'IN_PROGRESS',
    new_status: 'REJECTED',
    updated_by: 1,
    created_at: new Date('2024-12-21 19:42:34.339'),
  },
  {
    id: 3,
    message: 'The other status was for a different subscription',
    subscription_id: 3,
    prev_status: 'REJECTED',
    new_status: 'APPROVED',
    updated_by: 9,
    created_at: new Date('2024-12-21 19:43:25.121'),
  },
  {
    id: 4,
    message: 'Testing...',
    ...
    new_status: 'APPROVED',
    updated_by: 9,
    created_at: new Date('2024-12-21 19:46:32.08'),
  },
  {
    id: 5,
    message: '',
    ...
    new_status: 'IN_PROGRESS',
    updated_by: 9,
    created_at: new Date('2025-01-05 03:35:43.113'),
  },
  {
    id: 6,
    message: 'This message is optional anyway...',
    subscription_id: 5,
    prev_status: 'IN_PROGRESS',
    new_status: 'REJECTED',
    updated_by: 11,
    created_at: new Date('2025-01-05 03:36:19.515'),
  },
];
