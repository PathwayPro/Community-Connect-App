...
export class FilterPostsDto {
  ...
  @ApiPropertyOptional({
    description: 'Published or hidden posts (only ADMIN roles). Default: true',
    example: true,
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Posts from a specific user',
    example: 10,
  })
  @IsInt()
  @IsOptional()
...
export class FilterCommentsDto {
  @ApiPropertyOptional({
    description: 'Comments containing this word / phrase',
    example: 'LIKE "%search%"',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description:
      'Published or hidden comments (only ADMIN roles). Default: true',
    example: true,
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Comments from a specific user',
    example: 10,
  })
  @IsInt()
  @IsOptional()
